...
// Center of the map, now set to show all markers, formerly Rome [41.893, 12.48]
	...
	var overlays = {
		"<span style='color: grey'>5th c. BC</span>": 5th,
		"<span style='color: green'>4th c. BC</span>": 4th,
		"<span style='color: black'>3rd c. BC</span>": 3rd,
		"<span style='color: blue'>2nd c. BC</span>": 2nd,
		"<span style='color: red'>1st c. BC</span>": 1st
	};
