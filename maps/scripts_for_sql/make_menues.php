...
$sql = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA='" . $dbname . "' AND TABLE_NAME ='temples' ";
...
function makeOperatorMenu($id) {
	...
	echo '<option value="doesNotContain">does not contain</option>' . "\n"; 
