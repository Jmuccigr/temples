...
header='"name", "id", "type", "location", "city", "country", "orientation", "date", "startdateearly", "startdatelate", "century", "sex", "dedicationday", "deitytype", "extant", "source", "meetings", "blake", "coarellicm", "platnerandashby", "richardson", "stamper", "ziolkowski", "note", "vici.org", "pleiades", "dare", "arachne", "wikipedia", "wikidata", "longitude", "latitude"'

jq '.features[]' $dest/temples.json | jq '[ .properties.name, .properties.id, .properties.type, .properties.location, .properties.city, .properties.country, .properties.orientation, .properties.date, .properties.startdateearly, .properties.startdatelate, .properties.century, .properties.sex, .properties.dedicationday, .properties.deitytype, .properties.extant, .properties.source, .properties.meetings, .properties.blake, .properties.coarellicm, .properties.platnerandashby, .properties.richardson, .properties.stamper, .properties.ziolkowski, .properties.note, .properties."vici.org", .properties.pleiades, .properties.dare, .properties.arachne, .properties.wikipedia, .properties.wikidata,  .geometry.coordinates[0], .geometry.coordinates[1] ]' | jq -r @csv > "$temp/csv.csv"
